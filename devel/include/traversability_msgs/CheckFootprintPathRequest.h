...
struct CheckFootprintPathRequest_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::traversability_msgs::FootprintPath_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::traversability_msgs::FootprintPath_<ContainerAllocator> >::other >  _path_type;
  _path_type path;
