...
if("TRUE" STREQUAL "TRUE")
  set(octomap_rviz_plugins_SOURCE_PREFIX /home/kartik/perception_stack/src/octomap_rviz_plugins)
  set(octomap_rviz_plugins_DEVEL_PREFIX /home/kartik/perception_stack/devel)
  ...
  set(octomap_rviz_plugins_INSTALL_PREFIX /home/kartik/perception_stack/install)
...
if(NOT "/home/kartik/perception_stack/src/octomap_rviz_plugins/include;/opt/ros/melodic/include " STREQUAL " ")
  set(octomap_rviz_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/kartik/perception_stack/src/octomap_rviz_plugins/include;/opt/ros/melodic/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'octomap_rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kartik/perception_stack/src/octomap_rviz_plugins/${idir}'.  ${_report}")
    endif()
    _list_append_unique(octomap_rviz_plugins_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "octomap_rviz_plugins;/opt/ros/melodic/lib/liboctomap.so;/opt/ros/melodic/lib/liboctomath.so")
