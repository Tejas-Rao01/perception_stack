...
class update_frame_id:
    def __init__(self):
        ...
        self.sub_raw = rospy.Subscriber("/d435/color/image_raw", Image, self.callback_raw)
        self.sub_info = rospy.Subscriber("/d435/color/camera_info", CameraInfo, self.callback_info)
    ...
    def callback_raw(self, message):
        message.header.frame_id = "d435_depth_optical_frame"
