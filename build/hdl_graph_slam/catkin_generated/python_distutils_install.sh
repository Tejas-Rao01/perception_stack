...
echo_and_run cd "/home/stochlab/perception_stack/src/hdl_graph_slam"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/stochlab/perception_stack/build/hdl_graph_slam \
    build --build-base "/home/stochlab/perception_stack/build/hdl_graph_slam" \
    install \
    --root="${DESTDIR-/}" \
