...
echo_and_run cd "/home/stochlab/perception_stack/src/image_pipeline/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/stochlab/perception_stack/build/image_pipeline/camera_calibration \
    build --build-base "/home/stochlab/perception_stack/build/image_pipeline/camera_calibration" \
    install \
    --root="${DESTDIR-/}" \
