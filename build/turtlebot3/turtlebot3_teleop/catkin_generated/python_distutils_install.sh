...
echo_and_run cd "/home/stochlab/perception_stack/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/home/stochlab/perception_stack/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/stochlab/perception_stack/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
